      ...
      {flag === false && (
        <IonContent>
          ...
          >
            ...
            <Button shape={SHAPE.pill} kind={KIND.secondary} onClick={() => history.push('/home')}>
              <ArrowLeft />
            </Button>
            <Button
              shape={SHAPE.pill}
      ...
      {flag === true && (
        <IonContent>
          ...
          <IonButton color="primary" routerLink="/login-success">
            ...
            <Button shape={SHAPE.pill} kind={KIND.secondary} onClick={() => history.push('/login')}>
              <ArrowLeft />
            </Button>
            <Button
              shape={SHAPE.pill}
              kind={otp.every((digit) => digit !== '') ? KIND.primary : KIND.secondary}
